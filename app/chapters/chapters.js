  ...
  "15": {
    ...
    steps: [
      ...
      },
      {
        ...
        action_items: [
          {name: "Cash from Scholarship", description: "surg", amount: 5000, regular: false}
        ]
      }
    ],
    ...
    statements: {
      cash_flow_statement: {
        income: [
          {name: "Part-time Salary", item_description: "The campus employes you to lower the cost of the personnels here at the department.", amount: 1300, regular: true}
        ],
        expenses: [
          {name: "Rent", item_description: "A comfortable home services you physically, but you service it financially.", amount: 750, regular: true},
          {name: "Student Loan Monthly Pay", item_description: "not", amount: 45, regular: true},
          {name: "Credit Card Monthly Pay", item_description: "e", amount: 80, regular: true},
          {name: "Car Loan Monthly Pay", item_description: "2er", amount: 134, regular: true},
          {name: "Other Expenses", item_description: "A symbol of adulthood worth fighting for.", amount:244, regular: true},
        ],
      },
      balance_sheet: {
        assets: [
          {name: "Cash", item_description: "Home.", amount: 4470},
          {name: "Car", item_description: "", amount: 14500},
          {name: "Other Assets", item_description: "Simple, cold, and sure.", amount: 2300},
        ],
        liabilities: [
          {name: "Student Loan", item_description: "Your parents support your expenses", amount: 2000},
          {name: "Credit Card Balance", item_description: "credit", amount: 645},
          {name: "Car Loan", amount: 7500}
        ],
      },
      deleted: []
    },
    ...
    criteria: {
      should_contain: [
        ["income", "Cash from Scholarship"],
        ["income", "Part-time Salary"],
        ["expenses", "Rent"],
        ["expenses", "Student Loan Monthly Pay"],
        ["deleted", "Credit Card Monthly Pay"],
        ["deleted", "Car Loan Monthly Pay"],
        ["expenses", "Other Expenses"],
        ["assets", "Cash"],
        ["assets", "Other Assets"],
        ["assets", "Car"],
